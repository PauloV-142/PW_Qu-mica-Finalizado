...
var turbidimetriaM = document.getElementById("turbidimetriaM");
...
var turbidimetria = document.getElementById("turbidimetria");
...
var close20 = document.getElementsByClassName("close")[19];
...
turbidimetria.onclick = function() {
  if (turbidimetriaM.style.display == "block") {
    turbidimetriaM.style.display = "none";
  }
  else if (turbidimetriaM.style.display == "none" || turbidimetriaM.style.display == "") {
    turbidimetriaM.style.display = "block";
  }
}
...
window.onclick = function(event) {
  ...
  else if (event.target == carbonilaM) {
    carbonilaM.style.display = "none";
  }
  else if (event.target == catalisadorM) {
    catalisadorM.style.display = "none";
  }
  else if (event.target == cloroformioM) {
    cloroformioM.style.display = "none";
  }
  else if (event.target == compostoM) {
    compostoM.style.display = "none";
  }
  else if (event.target == corrosaoM) {
    corrosaoM.style.display = "none";
  }
  else if (event.target == cetonasM) {
    cetonasM.style.display = "none";
  }
  else if (event.target == digestorM) {
    digestorM.style.display = "none";
  }
  else if (event.target == etilenoglicolM) {
    etilenoglicolM.style.display = "none";
  }
  else if (event.target == surfatantesM) {
    surfatantesM.style.display = "none";
  }
  else if (event.target == turbidimetriaM) {
    turbidimetriaM.style.display = "none";
  }
}
